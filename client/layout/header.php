...
<head>
    ...
    <meta name="author" content=" Qzency" />
    ...
    <title>Tripfy - Travel Agency and Tour Booking HTML Template</title>
    <link rel="icon" href="assets/image/svg/tourpeak-small.svg" />
</head>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <img src="assets/image/card-img/login-modal-header-img.jpg" alt="" />
                </div>
                    ...
                    <div class="login-registration-form">
                        ...
                        <form>
                            ...
                            <a href="#" class="google-login-btn">
                                <div class="icon">
                                    <img src="assets/image/svg/google-icon.svg" alt="" />
                                </div>
                                Sign in with Google
                            </a>
                        </form>
    ...
    <header class="header-area style-4">
        <div class="container d-flex flex-nowrap align-items-center justify-content-between">
            <div class="header-logo">
                <a href="index.php"><img alt="image" class="img-fluid" src="assets/image/svg/logo.jpg" /></a>
            </div>
            <div class="main-menu">
                <div class="mobile-logo-area d-lg-none d-flex justify-content-between">
                    <div class="mobile-logo-wrap">
                        <a href="index.php"><img alt="image" class="img-fluid" src="assets/image/svg/logo.svg" /></a>
                    </div>
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a href="package-grid.php">All Tours</a>
                            </li>
                            <li><a href="packages/hotel.php">Hotels</a></li>
                            <li><a href="packages/flights.php">Flights</a></li>
                            <li><a href="packages/cruise.php">Cruises</a></li>
                            <li><a href="packages/visa.php">Visa</a></li>
                            <li><a href="packages/curranccyexchange.php">Currency Exchange</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children">
                        <a href="#" class="drop-down">Holiday Packages</a><i class="bi bi-plus dropdown-icon"></i>
                        <ul class="sub-menu">
                            <li>
                                <a href="#">Domestic</a>
                                ...
                                <ul class="sub-menu">
                                    <li><a href="package-grid.php">Destination</a></li>
                                    <li><a href="package-sidebar.php">no of nights/days</a></li>
                                    <li><a href="package-details.php">Honeymoon Tours</a></li>
                                    <li><a href="package-details.php">Corporate Tours</a></li>
                                    <li><a href="package-details.php">Adventure Tours</a></li>
                                    <li><a href="package-details.php">Spiritual Tours</a></li>
                                    <li><a href="package-details.php">Wildlife Tours</a></li>
                                </ul>
                            </li>
                            <li>
                ...
                <div class="btn-area d-lg-none d-flex justify-content-center">
                    <a class="primary-btn" href="/contact.php"> Let’s Talk </a>
                </div>
            </div>
            <div class="nav-right d-flex jsutify-content-end align-items-center">
                ...
                <a class="primary-btn d-lg-flex d-none" href="package-sidebar.php">Book A Trip</a>
