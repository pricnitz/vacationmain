                            ...
                            <form id="bookingForm" class="homeform">
                                <div class="row">
                                    <div class="col-lg-6 mb-3">
                                        <input type="text" name="name" class="form-controll" placeholder="First Name *"
                                            required>
                                    </div>
                                    <div class="col-lg-6 mb-3">
                                        <input type="text" name="name" class="form-controll" placeholder="Last Name *"
                                            required>
                                    </div>
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <input type="file" id="file-upload" class="form-controll" accept=".pdf,.doc,.docx,.txt">
                                        <small class="textthree">Drop you resume.</small>
                                    </div>
                                    <div class="col-lg-6 mb-3">
                                        <select class="custominput" name="position" class="form-controll" required>
